...
#debug!!!! open to re-run merge
merge_coeffs(os.path.join(paths.DATASETS_BASE,'sg_full/objects_266/train_output/train.20151223-134658',267))
...
if TRAIN_SVM:
    ...
    #debug - complete missing classes
    train_needed = [5, 6, 7, 8]#TODO-fill missing classes


    cls = train_needed[0]
    last_class = train_needed[-1]
    tmp_idx = 0
